<?php 
	...
	{
		$Documento = '';
		$NombreEmpleado = $data['Apellido1'] . ' ' . $data['Apellido2'] . ' ' . $data['Nombre1'] . ' ' . $data['Nombre2'];
		$Cargo = '';
	}
	...
	$dir = '/documents/' . $data['Documento'] . '_' . $data['Apellido1'] . '_' . $data['Apellido2'] . '_' . $data['Nombre1'] . '_' . $data['Nombre2'];
				...
				<div class="section section-data-tables">
					<div class="card">
						<div class="card-content white-text z-depth-2" style="background-color:#1b2140">
							<div class="row">
								...
								<div class="col s12 m6 l6 right-align">
									<h6 class="white-text"><?= 'PERÍODO: ' . $data['Periodo'] . '-' . $data['reg']['Ciclo'] ?></h6>
						...
						<div class="card-content">
							<div class="row">
								<div class="col s2">
									<?php get(label('Empleado*'), 'Documento', $data['Documento'], 'text', 15, FALSE, 'onblur="ConsultaEmpleado2(this.value); return false" required', ''); ?>
								</div>
								<div class="col s3">
									<?php get('', 'NombreEmpleado', $NombreEmpleado, 'text', 60, TRUE, '', ''); ?>
								</div>
								<div class="col s3">
									<?php get('', 'Cargo', $data['Cargo'], 'text', 60, TRUE, '', ''); ?>
								</div>
								<div class="col s1">
							...
							<div class="row">
								<div class="col s2">
									<?php get(label('Centro de costos*'), 'Centro', $data['Centro'], 'text', 5, FALSE, 'onblur="ConsultaCentro(this.value); return false" required', ''); ?>
								</div>
								<div class="col s3">
									<?php get('', 'NombreCentro', $data['NombreCentro'], 'text', 60, TRUE, '', ''); ?>
								</div>
								<div class="col s1">
