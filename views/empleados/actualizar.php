									...
									<div class="col s12 l9">
										<div id="pagIdentificacion" class="col s12">
											<div class="card-panel">
												...
												<?php 
													$dir = 'documents/' . $data['reg']['Documento'] . '_' . strtoupper($data['reg']['Apellido1']) . '_' . strtoupper($data['reg']['Apellido2']) . '_' . strtoupper($data['reg']['Nombre1']) . '_' . strtoupper($data['reg']['Nombre2']) . '/HV';
												...
												<div class="row">
													...
													<div class="input-field col s6 m6">
														<?php 
															get(label('Cedula extranjeria'), 'Documento2', $data['reg']['Documento2'], 'text', 15, FALSE, '', 'fas fa-pen'); 
														?>
													</div>
												</div>
												<div class="row">
