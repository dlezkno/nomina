<?php 
    ...
    $FechaInicialPeriodo = $data['reg']['FechaInicialPeriodo'];
    $FechaFinalPeriodo = $data['reg']['FechaFinalPeriodo'];
	$InformeResumido = $data['reg']['InformeResumido'];
?>
<div id="main">
	<div class="row">
							...
							<section class="tabs-vertical mt-1 section">
								<div class="card-panel">
									...
									<div class="row">
										...
										<div class="col s12 m4">
											<?php 
												get(label('Concepto'), 'Concepto', $data['reg']['Concepto'], 'text', 5, FALSE, '', 'fas fa-pen'); 
											?>
										</div>
									</div>
									<div class="row">
										<div class="col s12 m4">
											<?php 
												get(label('Fecha inicial'), 'FechaInicialPeriodo', $FechaInicialPeriodo, 'date', 10, FALSE, '', 'fas fa-pen'); 
											?>
										</div>
										<div class="col s12 m4">
											<?php 
												get(label('Fecha final'), 'FechaFinalPeriodo', $FechaFinalPeriodo, 'date', 10, FALSE, '', 'fas fa-pen'); 
											?>
										</div>
										<div class="col s12 m4">
											<?php 
												get(label('Informe resumido'), 'InformeResumido', $InformeResumido, 'checkbox', $InformeResumido, FALSE, '', ''); 
											?>
										</div>
									</div>
								</div>
