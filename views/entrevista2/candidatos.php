						...
						<div class="card-content white-text z-depth-2" style="background-color:#1b2140">
							<div class="row">
								<div class="col s12 m6 l6">
									<h3 class="white-text">Candidatos (Entrevista técnica)</h3>
								</div>
								<div class="col s12 m6 l6 right-align">
									<?php
										if	( isset($_SESSION['Paginar']) AND $_SESSION['Paginar'] )
											echo paginar(SERVERURL . '/entrevista2/lista', $data['registros'], $_SESSION['CANDIDATOS']['Pagina'] );
									?>
								</div>
							</div>
						</div>
									...
									<table>
										<thead>
											<tr>
												...
												<th>
													<?php 
														if	( $_SESSION['CANDIDATOS']['Orden'] == 'PARAMETROS.Detalle,EMPLEADOS.Apellido1,EMPLEADOS.Apellido2,EMPLEADOS.Nombre1' )
															echo '<a class="btn btn-block cyan darken-4" href="">' . label('ESTADO') . '</a>';
														else
														{
															echo '<button class="btn btn-block teal lighten-3" type="submit" name="Orden" value="PARAMETROS.Detalle,EMPLEADOS.Apellido1,EMPLEADOS.Apellido2,EMPLEADOS.Nombre1">';
																echo label('Estado');
															echo '</button>';
														}
													?>
										...
										<tbody>
											...
											<tr>
												<td class="center-align">
													<a class="tooltipped"
														href="<?= SERVERURL ?>/entrevista2/editar/<?= $reg['id'] ?>"
