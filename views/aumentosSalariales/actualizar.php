<?php 
	...
	$FechaAumento = $_REQUEST['FechaAumento'];
	$SueldoBasico = $_REQUEST['SueldoBasico'];
				...
				<div class="section section-data-tables">
					<div class="card">
						...
						<div class="card-content">
							<div class="row">
								<div class="col s2">
									<?php get(label('Empleado*'), 'Documento', $Documento, 'text', 15, TRUE, 'onblur="ConsultaEmpleado(this.value); return false" required', ''); ?>
								</div>
								<div class="col s3">
							...
							<div class="row">
								<div class="col s2">
									<?php get(label('Fecha aumento'), 'FechaAumento', $FechaAumento, 'date', 10, FALSE, '', ''); ?>
								</div>
								<div class="col s3">
									<?php get(label('Sueldo básico'), 'SueldoBasico', $SueldoBasico, 'number', 12, FALSE, '', ''); ?>
								</div>
							</div>
						</div>
						<div class="card-content white-text z-depth-2" style="background-color:#1b2140">
