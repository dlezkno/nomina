				...
				<div class="section section-data-tables">
					<div class="card">
						...
						<div class="card-content">
							...
							<div class="row">
								<div class="col s2">
									<?php get(label('Fecha aumento'), 'FechaAumento', $data['reg']['FechaAumento'], 'date', 10, FALSE, '', ''); ?>
								</div>
								<div class="col s3">
									<?php get(label('Sueldo básico'), 'SueldoBasico', $data['reg']['SueldoBasico'], 'number', 12, FALSE, '', ''); ?>
								</div>
							</div>
						</div>
						<div class="card-content white-text z-depth-2" style="background-color:#1b2140">
