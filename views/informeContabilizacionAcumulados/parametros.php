						...
						<div class="card-content white-text z-depth-2" style="background-color:#1b2140">
							<div class="row">
								<div class="col s12 m6 l6">
									<h3 class="white-text">Informe Contabilización de acumulados</h3>
								</div>
								...
								<div class="card-panel">
									<div class="card-alert card cyan darken-4">
										<div class="card-content white-text">
											<p>INFORME CONTABILIZACIÓN DE ACUMULADOS</p>
										</div>
									</div>
									<div class="row">
									...
									<div class="row">
										...
										<div class="col s12 m4">
											<?php 
												get(label('Empleado'), 'Documento', $data['reg']['Documento'], 'text', 15, FALSE, '', 'fas fa-pen'); 
											?>
										</div>
										<div class="col s12 m4">
											<?php 
												get(label('Cuenta'), 'Cuenta', $data['reg']['Cuenta'], 'text', 15, FALSE, '', 'fas fa-pen'); 
											?>
										</div>
									</div>
								</div>
