				...
				<div class="section section-data-tables">
					<div class="card">
						<div class="card-content white-text z-depth-2" style="background-color:#1b2140">
							<div class="row">
								<div class="col s12 m6 l6">
									<h3 class="white-text">Comprobantes contables</h3>
								</div>
						...
						<div class="card-content">
							<h5>Importar archivo de comprobantes contables</h5>
							...
							<div class="row">
								...
								<div class="file-field input-field col s6 m6 l6">
									<button class="btn btn-sm cyan darken-4" type="submit" id="download_format">
