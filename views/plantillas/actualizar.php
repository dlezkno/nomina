					...
					<div class="card">
						...
						<div class="card-content">
							...
							<div class="row">
								<div class="input-field col s12 m6">
									<?php 
										get(label('Tipo de plantilla*'), 'TipoPlantilla', $SelectTipoPlantilla, 'select', 0, FALSE, 'required', 'fas fa-ellipsis-v'); 
									?>
								</div>
								<div class="input-field col s12 m6">
									<?php 
										get(label('Tipo contrato*'), 'TipoContrato', $SelectTipoContrato, 'select', 0, FALSE, 'required', 'fas fa-ellipsis-v'); 
									?>
								</div>
							</div>
							<div class="row">
