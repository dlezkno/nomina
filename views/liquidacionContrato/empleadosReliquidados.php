						...
						<div class="card-content white-text z-depth-2" style="background-color:#1b2140">
							<div class="row">
								<div class="col s12 m6 l6">
									<h3 class="white-text">Empleados reliquidados</h3>
								</div>
								<div class="col s12 m6 l6 right-align">
									<?php
										if	( isset($_SESSION['Paginar']) AND $_SESSION['Paginar'] )
											echo paginar(SERVERURL . '/liquidacionContrato/listar', $data['registros'], $_SESSION['LIQ_CONTRATO']['Pagina'], $data['activar']);
									?>
								</div>
							</div>
						</div>
							...
							<div class="row">
								<div class="col s12">
									<table>
										<thead>
											<tr>
												<th><a id="checkall" style="cursor:pointer">RE LIQ.</a></th>
												<th>
													<?php 
										...
										<tbody>
											<?php
												for ($i=0; $i < count($data['rows']); $i++)
												{
													...
													$archivo = 'ReliquidacionContrato_' . $reg['Documento'] . '_' . $NombreEmpleado . '.PDF';
											?>
											<tr>
												<td><?php get('', 'okReLiquidar[]', $reg['Documento'], 'checkbox', 0, FALSE, 'class="checkreli"', 'dd');  ?></td>
												<td><?= $reg['Documento'] ?></td>
												...
												<?php endif; ?>
												<?php if (file_exists('descargas/ReliquidacionContrato_' . $reg['Documento'] . '_' . $NombreEmpleado . '.PDF')): ?>
												<td>
