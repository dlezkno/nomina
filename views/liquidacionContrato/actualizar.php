									...
									<div class="col s12 l9">
										<div id="pagIdentificacion" class="col s12">
											<div class="card-panel">
												...
												<?php 
													$dir = '/documents/' . $data['reg']['Documento'] . '_' . strtoupper($data['reg']['Apellido1']) . '_' . strtoupper($data['reg']['Apellido2']) . '_' . strtoupper($data['reg']['Nombre1']) . '_' . strtoupper($data['reg']['Nombre2']);
													$cDirectorio = SERVERURL . $dir;
													$archivo = getImage($dir,$cDirectorio);
													
												?>
												<div class="row center-align">
													<img src="<?= $archivo ?>" alt="Fotografia"
