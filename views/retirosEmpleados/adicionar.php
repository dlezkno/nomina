<?php 
	...
	$SelectMotivoRetiro = getSelect('MotivoRetiro', $data['reg']['MotivoRetiro'], '', 'PARAMETROS.Valor');
				...
				<div class="section section-data-tables">
					<div class="card">
						...
						<div class="card-content">
							...
							<div class="row">
								<div class="col s2">
									<?php get(label('Fecha retiro*'), 'FechaRetiro', $data['reg']['FechaRetiro'], 'date', 10, FALSE, '', ''); ?>
								</div>
								<div class="col s6">
