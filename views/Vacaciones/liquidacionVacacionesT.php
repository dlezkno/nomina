								...
								<div class="col s12 m6 l6">
									...
									<?php
										if	( isset($_SESSION['Paginar']) AND $_SESSION['Paginar'] )
											echo paginar(SERVERURL . '/Vacaciones/listaT', $data['registros'], $_SESSION['VACACIONES']['Pagina'] );
									?>
								</div>
							</div>
						</div>
										...
										<tbody>
											...
											<tr>
												<td class="center-align">
													<a class="tooltipped"
														href="<?= SERVERURL ?>/Vacaciones/borrarEnTiempo/<?= $reg['Id'] ?>"
												...
												<td>
													INICIO: <strong><?= $reg['FechaInicioVacaciones'] ?></strong>
													<br>
													INGRESO: <strong><?= $reg['FechaIngresoVacaciones'] ?></strong>
												</td>
												<td class="right-align">
													<strong><?= number_format($reg['ValorLiquidado'], 0) ?></strong>
												</td>
											</tr>
											<?php endfor; ?>
										</tbody>
