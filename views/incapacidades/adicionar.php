<?php 
	...
	$FechaIncapacidad 	= isset($_REQUEST['FechaIncapacidad']) ? $_REQUEST['FechaIncapacidad'] : NULL;
	$FechaInicio 		= isset($_REQUEST['FechaInicio']) ? $_REQUEST['FechaInicio'] : NULL;
	$DiasIncapacidad 	= isset($_REQUEST['DiasIncapacidad']) ? $_REQUEST['DiasIncapacidad'] : 0;
	$PorcentajeAuxilio 	= isset($_REQUEST['PorcentajeAuxilio']) ? $_REQUEST['PorcentajeAuxilio'] : 0;
	...
	$EsProrroga 		= isset($_REQUEST['EsProrroga']) ? TRUE : FALSE;

	$SelectBaseLiquidacion = getSelect('BaseLiquidacionIncapacidad', $data['reg']['BaseLiquidacion'], '', 'PARAMETROS.Valor');
					...
					<div class="card">
						...
						<div class="card-content">
							...
							<div class="row">
								...
								<div class="col s12 m3">
									<?php get(label('Fecha incapacidad*'), 'FechaIncapacidad', $data['reg']['FechaIncapacidad'], 'date', 10, FALSE, 'required', ''); ?>
								</div>
								<div class="col s12 m3">
									<?php get(label('Fecha inicio*'), 'FechaInicio', $data['reg']['FechaInicio'], 'date', 10, FALSE, 'required', ''); ?>
								</div>
							</div>
							<div class="row">
								<div class="col s12 m2">
