						...
						<div class="card-content">
							...
							<div class="row">
								<div class="input-field col s12 m6">
									<?php 
										get(label('Código ciudad*'), 'ciudad', $data['reg']['ciudad'], 'text', 5, FALSE, 'required', 'fas fa-pen'); 
									?>
								</div>
								<div class="input-field col s12 m6">
									<?php 
										get(label('Nombre de la ciudad*'), 'nombre', $data['reg']['nombre'], 'text', 25, FALSE, 'required', 'fas fa-pen'); 
									?>
								</div>
							</div>
							<div class="row">
								<div class="input-field col s12 m6">
									<?php 
										get(label('Departamento'), 'departamento', $data['reg']['departamento'], 'text', 25, FALSE, 'required', 'fas fa-pen'); 
									?>
								</div>
								<div class="input-field col s12 m6">
									<?php 
							...
							<div class="row">
								<div class="input-field col s12 m6">
									<?php 
										get(label('Orden'), 'orden', $data['reg']['orden'], 'number', 0, FALSE, '', 'fas fa-ellipsis-v');
									?>
								</div>
							</div>
						</div>
