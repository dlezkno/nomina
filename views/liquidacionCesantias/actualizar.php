							...
							<section class="tabs-vertical mt-1 section">
								<div class="card-panel">
									...
									<div class="row">
										...
										<div class="col s12 m6">
											<?php 
												get(label('Fecha de corte'), 'FechaCorte', $data['reg']['FechaCorte'], 'date', 10, FALSE, '', ''); 
											?>
										</div>
									</div>
									<!-- <div class="row">
										<div class="col s12 m6">
											<?php 
												get(label('Calcula sobre año anterior'), 'CalculaAnoAnterior', $data['reg']['CalculaAnoAnterior'], 'checkbox', $data['reg']['CalculaAnoAnterior'], FALSE, '', ''); 
											?>
										</div>
									</div> -->
									<div class="row">
										<div class="col s12 m6">
											<?php 
												get(label('Generar novedades'), 'GenerarNovedades', $data['reg']['GenerarNovedades'], 'checkbox', $data['reg']['GenerarNovedades'], FALSE, '', ''); 
											?>
										</div>
										<div class="col s12 m6">
											<?php 
												get(label('Transfiere a Fondo Cesantías'), 'TransfiereFC', $data['reg']['TransfiereFC'], 'checkbox', $data['reg']['TransfiereFC'], FALSE, '', ''); 
											?>
										</div>
									</div>
								</div>
