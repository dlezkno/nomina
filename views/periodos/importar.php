				...
				<div class="section section-data-tables">
					<div class="card">
						...
						<div class="card-content">
							<h5>Importar archivo de períodos de pago</h5>
							...
							<div class="row">
								...
								<div class="col s2"><strong>REFERENCIA</strong></div>
								<div class="col s2"><strong>PERIODICIDAD</strong></div>
								<div class="col s2"><strong>PERÍODO</strong></div>
								<div class="col s2"><strong>FECHA DE INICIO</strong></div>
