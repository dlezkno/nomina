					...
					<div class="card">
						...
						<div class="card-content">
							<div class="row">
								<div class="col s12">
									<div class="row">
										<div class="col s2">EMPLEADO</div>
										<div class="col s4">NOMBRE EMPLEADO</div>
									...
									<?php
										...
										for ($i = 0; $i < count($data['rows']); $i++):
											...
											$NombreConcepto = $reg['NombreConcepto'];
									...
									?>
												...
												<div class="row">
													...
													<div class="col s4">
														TOTAL POR <strong><?= $ConceptoAnt . ' - ' . $NombreConceptoAnt ?></strong>
													</div>
													<div class="col s2"></div>
													<div class="col s2 right-align"><?= number_format($TotalDb, 0) ?></div>
													<div class="col s2 right-align"><?= number_format($TotalCr, 0) ?></div>
												</div>
											</div>
										</li>
									<?php
										...
										<li>
											<div class="collapsible-header">
												<div class="row">
													<div class="col"></div>
													<div class="col">																
														<strong><?= $Concepto . ' - ' . $NombreConcepto ?></strong>
													</div>
												</div>
											</div>
									...
									?>
												<div class="row">
													...
													<div class="col s4"><?= $NombreEmpleado ?></div>
