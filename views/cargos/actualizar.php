<?php 
	...
	if ($data['reg']['IdCargoBase'] > 0)
	{
		$regPerfil = getRegistro('PERFILES', 0, 'PERFILES.IdCargoBase = ' . $data['reg']['IdCargoBase']);
	...
	else
	{
		...
		$SelectNivelAcademico = getSelect('NivelAcademico', $data['regPerfil']['NivelAcademico'], '', 'PARAMETROS.Valor');

		$Estudios = $data['regPerfil']['Estudios'];
		$ExperienciaLaboral = $data['regPerfil']['ExperienciaLaboral'];
		$FormacionAdicional = $data['regPerfil']['FormacionAdicional'];
		$CondicionesTrabajo = $data['regPerfil']['CondicionesTrabajo'];
		$MisionCargo = $data['regPerfil']['MisionCargo'];
		$Funciones = $data['regPerfil']['Funciones'];
		...
		$Responsable = $data['regPerfil']['Responsable'];
		$Elabora = $data['regPerfil']['Elabora'];
	}
?>
<div id="main">
    <div class="row">
