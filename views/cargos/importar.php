				...
				<div class="section section-data-tables">
					<div class="card">
						...
						<div class="card-content">
							<h5>Importar archivo de cargos de empleados</h5>
							...
							<div class="row">
								...
								<div class="col s2"><strong>SUELDO MIN</strong></div>
								<div class="col s2"><strong>SUELDO MAX</strong></div>
								<div class="col s2"><strong>CARGO SUP</strong></div>
							</div>
							<div class="row">
