<?php
	class liquidacionPrimaModel extends pgSQL
	{
		...
		public function listarLiquidacionPrima($ArchivoNomina, $query1, $query)
		{
			$query = <<<EOD
				WITH TOTALES AS (
					SELECT EMPLEADOS.Id, 
		...
		public function exportarPrima($ArchivoNomina, $query)
		{
			$query = <<<EOD
		...
		public function guardarNovedadRetencion($ArchivoNomina, $datos)
		{
			$query = <<<EOD
				INSERT INTO $ArchivoNomina 
